        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="navbar-nav w-100 d-flex justify-content-between">
                <div class="d-flex">
                    ...
                    <a class="nav-link active" aria-current="page" href=<%=appPath + "/manageUsers"%>>Amministra
                        utenti</a>
                    <a class="nav-link active" aria-current="page" href=<%=appPath + "/manageEvents"%>>Amministra
                        eventi</a>
                    <%}%>
                </div>
                <div class="d-flex">
                    ...
                    <a class="nav-link active text-danger" aria-current="page"
                       href=<%=appPath + "/auth/logout"%>>Logout</a>
                    <%}%>
